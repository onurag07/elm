                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" minlength="10" maxlength="10" name="phone" value="{{ old('phone') }}" required autocomplete="Phone">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="doj" type="date" class="form-control @error('doj') is-invalid @enderror" name="doj" value="{{ old('doj') }}" required autocomplete="doj">
